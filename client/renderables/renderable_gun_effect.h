...
class RenderableGunEffect {
    ...
    void update(const SDL2pp::Point& player_position, const SDL2pp::Point& gun_position, const SDL2pp::Point& aim_position, double facing_angle, WeaponType weapon_type, bool is_shooting);
